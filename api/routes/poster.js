...
router.get('/', asyncHandler(async (req, res) => {
    try {
        ...
        res.status(200).json({ success: true, message: "Posters retrieved successfully.", data: posters });
    } catch (error) {
...
router.get('/:id', asyncHandler(async (req, res) => {
    try {
        ...
        res.status(200).json({ success: true, message: "Poster retrieved successfully.", data: poster });
    } catch (error) {
        res.status(500).json({ success: false, message: error.message });
    }
}));
    ...
    try {
        uploadPosters.single('img')(req, res, async function (err) {
            ...
            try {
                ...
                res.status(200).json({ success: true, message: "Poster created successfully.", data: newPoster });
            } catch (error) {
